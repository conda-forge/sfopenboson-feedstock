...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sfopenboson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14734&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sfopenboson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sfopenboson` can be installed with:

```
conda install sfopenboson
```

It is possible to list all of the versions of `sfopenboson` available on your platform with:
